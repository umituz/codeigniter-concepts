        ...
        <div class="col-md-auto hidden-md-down pl-3">
          ...
          <div class="header-first clearfix">
            ...
            <div id="logo" class="logo">
              <a href="<?php echo base_url(); ?>"><img id="logo_img" src="<?php echo base_url("assets/"); ?>images/logo_purple.png" alt="<?php echo $settings->company_name ?>"></a>
            </div>
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="navbar-brand clearfix hidden-lg-up">
                  ...
                  <div id="logo-mobile" class="logo">
                    <a href="<?php echo base_url(); ?>"><img id="logo-img-mobile" src="<?php echo base_url("assets/"); ?>images/logo_purple.png" alt="<?php echo $settings->company_name ?>"></a>
                  </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                  ...
                  <ul class="navbar-nav ml-xl-auto">
                    ...
                    <?php $menus=get_top_menus(); ?>
                    <?php foreach($menus as $menu){ ?>
                      <?php $submenus=get_bottom_menus($menu->id); ?>
                      <li class="nav-item <?php if($submenus != array()){echo 'dropdown';} ?>">
                        <a class="nav-link" href="<?php echo $menu->url; ?>"><?php echo $menu->title; ?></a>
                        <?php if($submenus != array()){echo '<ul class="dropdown-menu" aria-labelledby="third-dropdown">';} ?>
                        <?php foreach($submenus as $submenu){ ?>
                          <li><a href="<?php echo $submenu->url; ?>"><?php echo $submenu->title; ?></a></li>
                        <?php } ?>
                        <?php if($submenus != array()){echo '</ul>';} ?>
                      </li>
                    <?php } ?>
