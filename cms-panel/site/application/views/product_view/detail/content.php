                ...
                <div id="slider-banner-boxedwidth" class="slider-banner-boxedwidth rev_slider" data-version="5.0">
                  <ul class="slides">
                   ...
                   <?php foreach($product_images as $image){ ?> 
                      ...
                      <!-- main image -->
                      <img src="<?php echo base_url("panel/uploads/product/$image->img_url"); ?>" alt="" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
