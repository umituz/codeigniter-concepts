	...
	<div class="col-md-12">
		<div class="widget">
			...
			<div class="widget-body">
				...
				<form action="<?php echo base_url("course/update/{$item->id}"); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="row ">
						<div class="col-md-1 image_upload_container">
							<img width="100" height="50" src="<?php echo get_picture($viewFolder,$item->img_url,"255x157"); ?>" alt="" class="img-responsive">
						</div>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<input type="hidden" value="<?php echo $item->event_date ?>" name="event_date" id="datetimepicker1" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format:'YYYY-MM-DD HH:mm:ss' }"></div>
						</div>
					</div>
