	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tbody class="sortable" data-url="<?php echo base_url("portfolio/imageRankSetter"); ?>">
			...
			<tr id="order-<?php echo $image->id  ?>">
				...
				<td>
					<img width="50" height="50" src="<?php echo get_picture($viewFolder,$image->img_url,"255x157"); ?>" class="img-responsive"></img>
				</td>
				...
				<td class="text-center">
					<button data-url="<?php echo base_url("portfolio/imageDelete/{$image->id}/{$image->portfolio_id}"); ?>" class="btn btn-outline btn-sm btn-danger btn-block remove-sweetalert">
