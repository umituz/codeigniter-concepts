	...
	<div class="col-md-12">
		<div class="widget">
			...
			<div class="widget-body">
				...
				<form action="<?php echo base_url("page/update/{$item->id}"); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="row ">
						<div class="col-md-1 image_upload_container">
							<img width="100" height="50" src="<?php echo base_url("uploads/{$viewFolder}/$item->img_url"); ?>" alt="" class="img-responsive">
						</div>
