<div class="row">
	<div class="col-md-12">
		<h4 class="m-b-lg">
			Haber Listesi <a href="<?php echo base_url('news/new_form'); ?>" class="btn btn-outline btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Yeni Ekle</a>
		</h4>
	</div>
	<div class="col-md-12">
						...
						<?php foreach($items as $item){ ?>
							...
							<td>
								<?php if($item->news_type == "image"){ ?>
									<img width="75" src="<?php echo get_picture($viewFolder,$item->img_url,"513x289"); ?>" alt="" class="img-rounded">
							...
							<td>
								<button data-url="<?php echo base_url("news/delete/{$item->id}"); ?>" class="btn btn-outline btn-sm btn-danger remove-sweetalert">
									<i class="fa fa-trash"></i> Sil
								</button>
								<a href="<?php echo base_url("news/update_form/{$item->id}"); ?>" class="btn btn-outline btn-sm btn-purple">
