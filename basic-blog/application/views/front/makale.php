...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('<?php echo base_url('assets/front/') ?>img/post-bg.jpg')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-heading">
              ...
              <h2 class="subheading"><?php echo $row->seo; ?></h2>
              <span class="meta"><?php echo $row->eklenme_tarihi; ?></span>
            </div>
          </div>
        </div>
      </div>
