...
<div class="wrapper">
  ...
  <?php $this->load->view("back/icerik_kategori/add/breadcrumbs"); ?>
  <section class="content">
  <div class="row">
  <?php $this->load->view("back/icerik_kategori/add/content"); ?>
  </div>
  </section>
  </div>
...
<?php $this->load->view("back/icerik_kategori/add/page_script"); ?>
</body>
</html>
