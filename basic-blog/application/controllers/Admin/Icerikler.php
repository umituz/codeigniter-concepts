...
class Icerikler extends CI_Controller {
	...
	public function index()
	{
		...
		$viewData->rows = $this->icerik->get_all(array(),"sira ASC","*");
		$viewData->genel_ayar = $this->genel_ayar->get(array("id" => 0));
		$this->load->view('back/icerikler',$viewData);
	}
	...
	public function duzenle($id)
	{
		...
		$viewData->kategoriler = $this->icerik_kategori->get_all(array(),"sira ASC","*");
